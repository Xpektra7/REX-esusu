...
export function RightPanel() {
  ...
  const notifications = ((notifRes?.data as { notifications: NotificationItem[] } | undefined)?.notifications ?? []).slice(0, 5);
  const transactions = ((txRes?.data as { transactions: TransactionItem[] } | undefined)?.transactions ?? []).slice(0, 5);
